...
import { CompleteFn, ErrorFn, NextFn, Subscribe, Unsubscribe } from './implementation/observer';
...
export declare class UploadTask {
     ...
     */
    on(type: TaskEvent, nextOrObserver?: NextFn<UploadTaskSnapshot> | {
        [name: string]: any;
    } | null, error?: ErrorFn | null, completed?: CompleteFn | null): Unsubscribe | Subscribe<UploadTaskSnapshot>;
    /**
